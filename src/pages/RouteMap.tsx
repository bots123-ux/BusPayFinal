...
const ROUTES: RouteInfo[] = [
  {
    ...
    stops: [
      ...
      { name: "Baguio City Terminal", time: "+3h 50m", note: "Final destination — Gov. Pack Road, Baguio City" },
    ],
  },
  {
    id: "manila-launion",
    ...
    stops: [
      ...
      { name: "San Fernando, La Union", time: "+4h 03m", note: "Final destination — Quezon Ave, San Fernando" },
    ],
  },
  {
    id: "manila-vigan",
    ...
    stops: [
      ...
      { name: "San Fernando, La Union", time: "+4h 03m", note: "Midpoint rest stop" },
      { name: "Narvacan, Ilocos Sur", time: "+5h 30m", note: "Approaching Ilocos region" },
      { name: "Vigan City Terminal", time: "+6h 24m", note: "Final destination — Mestizo District, Vigan" },
    ],
  },
  {
    id: "manila-pagudpud",
    ...
    distance: "554 km",
    duration: "8 hrs 58 mins (alt. route: 11 hrs 18 mins)",
    fare: "₱980",
    mapSrc:
    ...
    stops: [
      ...
      { name: "Urdaneta, Pangasinan", time: "+3h 00m", note: "Rest stop" },
      { name: "San Fernando, La Union", time: "+4h 03m", note: "Midpoint rest stop" },
      { name: "Vigan City", time: "+6h 24m", note: "Ilocos Sur stop" },
      { name: "Laoag City", time: "+8h 00m", note: "Ilocos Norte capital" },
      { name: "Pagudpud, Ilocos Norte", time: "+8h 58m", note: "Final destination — Saud Beach area (primary route)" },
    ],
  },
];
