...
const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "San Fernando, La Union", time: "+5h 30m", note: "Final destination — Quezon Ave, San Fernando" },
    ],
  },
  {
    id: "manila-vigan",
    ...
    stops: [
      ...
      { name: "San Fernando, La Union", time: "+5h 30m", note: "Midpoint rest stop" },
      { name: "Narvacan, Ilocos Sur", time: "+7h 30m", note: "Approaching Ilocos region" },
      { name: "Vigan City Terminal", time: "+9h 00m", note: "Final destination — Mestizo District, Vigan" },
    ],
  },
  {
    id: "manila-pagudpud",
    ...
    stops: [
      ...
      { name: "Urdaneta, Pangasinan", time: "+3h 00m", note: "Rest stop" },
      { name: "San Fernando, La Union", time: "+5h 30m", note: "Midpoint rest stop" },
      { name: "Vigan City", time: "+9h 00m", note: "Ilocos Sur stop" },
      { name: "Laoag City", time: "+10h 00m", note: "Ilocos Norte capital" },
      { name: "Pagudpud, Ilocos Norte", time: "+11h 00m", note: "Final destination — Saud Beach area" },
    ],
  },
];
